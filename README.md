...
## API
Мы использовали различные API такие как MapKit, Jivo, Google Sheet API, Telegram API С ними у нас получилось реализоват полноценный сайт для компании, и показать возможности взаимодействия пользовательского опыта с сайтом
